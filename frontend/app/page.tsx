...
import BasicNavbar from "@/components/home/basic-navbar";
import FadeInImage from "@/components/home/fade-in-image";
import AppScreenshotSkewed from "@/components/home/app-screenshot-skewed";
            ...
            <div className="relative flex h-screen min-h-dvh w-full flex-col overflow-hidden bg-background">
                ...
                <main className="container mx-auto mt-[80px] flex max-w-[1024px] flex-col items-start px-8">
                    <section className="z-20 flex flex-col items-start justify-center gap-[18px] sm:gap-6">
                        <Button
                            ...
                            variant="bordered"
                        >
                            Для тех, кто тратит часы на сведение отчетов вручную.
                        </Button>
                        <LazyMotion features={domAnimation}>
                            ...
                            >
                                <AnimatePresence mode="wait">
                                    ...
                                    >
                                        <div className="bg-hero-section-title bg-clip-text text-white dark:from-[#FFFFFF] dark:to-[#FFFFFF66]">
                                            Ваша аналитика на автопилоте <br /> От клика до сделки.
                                        </div>
                                    </m.div>
                                    ...
                                    >
                                        Бесшовная интеграция CRM, Яндекс.Директа и Calltouch — готовые отчёты по ROMI, LTV и стоимости клиента в реальном времени.
                                    </m.div>
                ...
                <div className="pointer-events-none absolute inset-0 top-[-25%] z-10 scale-150 select-none sm:scale-125">
                    <FadeInImage
                        ...
                        src="/components-images/backgrounds/bg-gradient.png"
                    />
                </div>
            </div>
        </div>
